...
{
    [Migration(202101221506)]
    public class Scaner1cDocDataIndexV1 : Migration
    {
        ...
        public override void Up()
        {
            Execute.Sql(@"
GO
CREATE NONCLUSTERED INDEX [IX_Scaner_1cDocData_Article]
    ON [dbo].[Scaner_1cDocData]([Article] ASC);

GO
CREATE NONCLUSTERED INDEX [IX_Scaner_1cDocData_PlanNum]
    ON [dbo].[Scaner_1cDocData]([PlanNum] ASC);
