...
{
    [Migration(202106181138)]
    public class DocData_CreatedDate : Migration
    {
        ...
        public override void Up()
        {
			Execute.Sql(@"
GO
ALTER TABLE [dbo].[Scaner_1cDocData]
    ADD [DateCreated] DATETIME DEFAULT getdate() NULL;


GO
PRINT N'Идет создание Процедура [dbo].[GetAddressLocationByTask]…';
...
END
GO
PRINT N'Идет создание Процедура [dbo].[GetGoodsByTask]…';
